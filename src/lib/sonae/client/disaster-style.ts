...
const TONES: Record<string, DisasterTone> = {
  ...
  高潮: {
    border: 'rgba(13, 148, 136, 0.65)',
    fill: 'rgba(13, 148, 136, 0.18)',
    text: 'rgba(94, 234, 212, 0.95)',
  },
  土砂災害: {
    border: 'rgba(146, 64, 14, 0.7)',
  ...
  危険物災害: {
    border: 'rgba(133, 77, 14, 0.7)',
    fill: 'rgba(133, 77, 14, 0.18)',
    text: 'rgba(253, 224, 71, 0.95)',
  },
  化学物質災害: {
    border: 'rgba(133, 77, 14, 0.65)',
    fill: 'rgba(133, 77, 14, 0.16)',
    text: 'rgba(253, 224, 71, 0.95)',
  },
  放射性物質災害: {
    border: 'rgba(101, 163, 13, 0.6)',
    fill: 'rgba(101, 163, 13, 0.16)',
    text: 'rgba(190, 242, 100, 0.95)',
  },
  海上災害: {
  ...
  鉄道災害: {
    ...
    fill: 'rgba(82, 82, 91, 0.18)',
    text: 'rgba(212, 212, 216, 0.95)',
  },
  道路災害: {
    border: 'rgba(82, 82, 91, 0.7)',
    fill: 'rgba(82, 82, 91, 0.18)',
  ...
  雑踏事故: {
    border: 'rgba(120, 113, 108, 0.65)',
    fill: 'rgba(120, 113, 108, 0.15)',
    text: 'rgba(231, 229, 228, 0.9)',
  },
  不発弾災害: {
    border: 'rgba(133, 77, 14, 0.55)',
    fill: 'rgba(133, 77, 14, 0.14)',
